...
void f(void *arg)
{
    ...
    while (1) {
       ...
       e:	5fe78793          	addi	a5,a5,1534 # 2608 <k>
      12:	439c                	lw	a5,0(a5)
      14:	2785                	addiw	a5,a5,1
      16:	0007871b          	sext.w	a4,a5
      1a:	00002797          	auipc	a5,0x2
      1e:	5ee78793          	addi	a5,a5,1518 # 2608 <k>
      22:	c398                	sw	a4,0(a5)
      24:	b7dd                	j	a <f+0xa>
...
{   
    ...
    printf("\nexited\n");
      ...
      d8:	39c50513          	addi	a0,a0,924 # 2470 <schedule_dm+0x288>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     6e6:	ee668693          	addi	a3,a3,-282 # 25c8 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     7c0:	e0c70713          	addi	a4,a4,-500 # 25c8 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     980:	b0478793          	addi	a5,a5,-1276 # 2480 <schedule_dm+0x298>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     b2c:	af878793          	addi	a5,a5,-1288 # 2620 <freep>
     b30:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     c24:	a0078793          	addi	a5,a5,-1536 # 2620 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     ca6:	97e78793          	addi	a5,a5,-1666 # 2620 <freep>
     caa:	639c                	ld	a5,0(a5)
}
     cac:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     cd8:	94c78793          	addi	a5,a5,-1716 # 2620 <freep>
     cdc:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     cec:	92878793          	addi	a5,a5,-1752 # 2610 <base>
     cf0:	fef43023          	sd	a5,-32(s0)
     cf4:	00002797          	auipc	a5,0x2
     cf8:	92c78793          	addi	a5,a5,-1748 # 2620 <freep>
     cfc:	fe043703          	ld	a4,-32(s0)
     d00:	e398                	sd	a4,0(a5)
     d02:	00002797          	auipc	a5,0x2
     d06:	91e78793          	addi	a5,a5,-1762 # 2620 <freep>
     d0a:	6398                	ld	a4,0(a5)
     d0c:	00002797          	auipc	a5,0x2
     d10:	90478793          	addi	a5,a5,-1788 # 2610 <base>
     d14:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     d16:	00002797          	auipc	a5,0x2
     d1a:	8fa78793          	addi	a5,a5,-1798 # 2610 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     d96:	88e78793          	addi	a5,a5,-1906 # 2620 <freep>
    ...
    if(p == freep)
     ...
     dac:	87878793          	addi	a5,a5,-1928 # 2620 <freep>
     db0:	639c                	ld	a5,0(a5)
...
static inline void list_del(struct list_head *entry)
{
    ...
    entry->next = LIST_POISON1;
     ...
     f34:	10070713          	addi	a4,a4,256 # 100100 <__global_pointer$+0xfd338>
     f38:	e398                	sd	a4,0(a5)
    entry->prev = LIST_POISON2;
     f3a:	fe843783          	ld	a5,-24(s0)
     f3e:	00200737          	lui	a4,0x200
     f42:	20070713          	addi	a4,a4,512 # 200200 <__global_pointer$+0x1fd438>
     f46:	e798                	sd	a4,8(a5)
}
     f48:	0001                	nop
...
struct thread *thread_create(void (*f)(void *), void *arg, int is_real_time, int processing_time, int period, int n)
{
    ...
    t->ID = _id++;
     ...
     ff2:	61678793          	addi	a5,a5,1558 # 2604 <_id.1229>
     ff6:	439c                	lw	a5,0(a5)
     ff8:	0017871b          	addiw	a4,a5,1
     ffc:	0007069b          	sext.w	a3,a4
    1000:	00001717          	auipc	a4,0x1
    1004:	60470713          	addi	a4,a4,1540 # 2604 <_id.1229>
...
void thread_add_at(struct thread *t, int arrival_time)
{
    ...
    1110:	4e458593          	addi	a1,a1,1252 # 25f0 <release_queue>
    1114:	853e                	mv	a0,a5
...
void __release()
{
    ...
    1134:	4c078793          	addi	a5,a5,1216 # 25f0 <release_queue>
    ...
    1168:	4cc78793          	addi	a5,a5,1228 # 2630 <threading_system_time>
    ...
    11aa:	43a58593          	addi	a1,a1,1082 # 25e0 <run_queue>
    11ae:	853e                	mv	a0,a5
    ...
    11fc:	3f878793          	addi	a5,a5,1016 # 25f0 <release_queue>
...
void __thread_exit(struct thread *to_remove)
{
    ...
    1226:	40678793          	addi	a5,a5,1030 # 2628 <current>
    ...
    126e:	39678793          	addi	a5,a5,918 # 2600 <main_thrd_id>
...
void thread_exit(void)
{
    ...
    1294:	39878793          	addi	a5,a5,920 # 2628 <current>
    1298:	6398                	ld	a4,0(a5)
    129a:	00001797          	auipc	a5,0x1
    129e:	34678793          	addi	a5,a5,838 # 25e0 <run_queue>
    ...
    12aa:	1e258593          	addi	a1,a1,482 # 2488 <schedule_dm+0x2a0>
    12ae:	4509                	li	a0,2
    ...
    12c6:	36678793          	addi	a5,a5,870 # 2628 <current>
...
void __finish_current()
{
    ...
    133c:	2f078793          	addi	a5,a5,752 # 2628 <current>
    ...
    136e:	2c678793          	addi	a5,a5,710 # 2630 <threading_system_time>
    ...
    1382:	14250513          	addi	a0,a0,322 # 24c0 <schedule_dm+0x2d8>
...
void __rt_finish_current()
{
    ...
    1400:	22c78793          	addi	a5,a5,556 # 2628 <current>
    ...
    1432:	20278793          	addi	a5,a5,514 # 2630 <threading_system_time>
    ...
    1446:	09650513          	addi	a0,a0,150 # 24d8 <schedule_dm+0x2f0>
...
void switch_handler(void *arg)
{
    ...
    14d0:	15c78793          	addi	a5,a5,348 # 2628 <current>
    ...
    14f2:	14278793          	addi	a5,a5,322 # 2630 <threading_system_time>
    ...
    1506:	12e78793          	addi	a5,a5,302 # 2630 <threading_system_time>
    ...
    1546:	0ee78793          	addi	a5,a5,238 # 2630 <threading_system_time>
    ...
    155a:	0da78793          	addi	a5,a5,218 # 2630 <threading_system_time>
    ...
    1578:	0bc78793          	addi	a5,a5,188 # 2630 <threading_system_time>
    157c:	439c                	lw	a5,0(a5)
    157e:	863e                	mv	a2,a5
    1580:	85ba                	mv	a1,a4
    1582:	00001517          	auipc	a0,0x1
    1586:	f8e50513          	addi	a0,a0,-114 # 2510 <schedule_dm+0x328>
    ...
    15f6:	fee58593          	addi	a1,a1,-18 # 25e0 <run_queue>
    ...
    1622:	fe278793          	addi	a5,a5,-30 # 2600 <main_thrd_id>
...
void __dispatch()
{
    ...
    1648:	fe478793          	addi	a5,a5,-28 # 2628 <current>
    164c:	6398                	ld	a4,0(a5)
    164e:	00001797          	auipc	a5,0x1
    1652:	f9278793          	addi	a5,a5,-110 # 25e0 <run_queue>
    ...
    165e:	fce78793          	addi	a5,a5,-50 # 2628 <current>
    ...
    1680:	fbc78793          	addi	a5,a5,-68 # 2638 <allocated_time>
    ...
    169c:	e7850513          	addi	a0,a0,-392 # 2510 <schedule_dm+0x328>
    ...
    16bc:	f7878793          	addi	a5,a5,-136 # 2630 <threading_system_time>
    16c0:	4390                	lw	a2,0(a5)
    16c2:	00001797          	auipc	a5,0x1
    16c6:	f7678793          	addi	a5,a5,-138 # 2638 <allocated_time>
    16ca:	639c                	ld	a5,0(a5)
    16cc:	86be                	mv	a3,a5
    16ce:	85ba                	mv	a1,a4
    16d0:	00001517          	auipc	a0,0x1
    16d4:	e6850513          	addi	a0,a0,-408 # 2538 <schedule_dm+0x350>
    ...
    16ec:	f5078793          	addi	a5,a5,-176 # 2638 <allocated_time>
    ...
    1702:	f3a78793          	addi	a5,a5,-198 # 2638 <allocated_time>
    ...
    174c:	ef078793          	addi	a5,a5,-272 # 2638 <allocated_time>
    ...
    1762:	eda78793          	addi	a5,a5,-294 # 2638 <allocated_time>
    ...
    178a:	de258593          	addi	a1,a1,-542 # 2568 <schedule_dm+0x380>
    178e:	4509                	li	a0,2
...
void __schedule()
{
    ...
    1822:	9ca080e7          	jalr	-1590(ra) # 21e8 <schedule_dm>
    1826:	872a                	mv	a4,a0
    1828:	87ae                	mv	a5,a1
...
void back_to_main_handler(void *arg)
{
    ...
    186a:	dce78793          	addi	a5,a5,-562 # 2634 <sleeping>
    ...
    187e:	db678793          	addi	a5,a5,-586 # 2630 <threading_system_time>
    ...
    1892:	da278793          	addi	a5,a5,-606 # 2630 <threading_system_time>
    1896:	c398                	sw	a4,0(a5)
    thrdresume(main_thrd_id);
    1898:	00001797          	auipc	a5,0x1
    189c:	d6878793          	addi	a5,a5,-664 # 2600 <main_thrd_id>
...
void thread_start_threading()
{
    ...
    18c2:	d7278793          	addi	a5,a5,-654 # 2630 <threading_system_time>
    18c6:	0007a023          	sw	zero,0(a5)
    current = &run_queue;
    18ca:	00001797          	auipc	a5,0x1
    18ce:	d5e78793          	addi	a5,a5,-674 # 2628 <current>
    18d2:	00001717          	auipc	a4,0x1
    18d6:	d0e70713          	addi	a4,a4,-754 # 25e0 <run_queue>
    ...
    18ea:	d1a58593          	addi	a1,a1,-742 # 2600 <main_thrd_id>
    ...
    18fe:	d0678793          	addi	a5,a5,-762 # 2600 <main_thrd_id>
    ...
    1926:	cde78793          	addi	a5,a5,-802 # 2600 <main_thrd_id>
    ...
    1944:	ca050513          	addi	a0,a0,-864 # 25e0 <run_queue>
    ...
    1958:	c9c50513          	addi	a0,a0,-868 # 25f0 <release_queue>
    ...
    196c:	cd078793          	addi	a5,a5,-816 # 2638 <allocated_time>
    1970:	639c                	ld	a5,0(a5)
    1972:	85be                	mv	a1,a5
    1974:	00001517          	auipc	a0,0x1
    1978:	c2c50513          	addi	a0,a0,-980 # 25a0 <schedule_dm+0x3b8>
    197c:	fffff097          	auipc	ra,0xfffff
    1980:	148080e7          	jalr	328(ra) # ac4 <printf>
        sleeping = 1;
    1984:	00001797          	auipc	a5,0x1
    1988:	cb078793          	addi	a5,a5,-848 # 2634 <sleeping>
    198c:	4705                	li	a4,1
    ...
    1994:	ca878793          	addi	a5,a5,-856 # 2638 <allocated_time>
    1998:	639c                	ld	a5,0(a5)
    199a:	0007871b          	sext.w	a4,a5
    199e:	00001797          	auipc	a5,0x1
    19a2:	c9a78793          	addi	a5,a5,-870 # 2638 <allocated_time>
    ...
    19b6:	c4e58593          	addi	a1,a1,-946 # 2600 <main_thrd_id>
    19ba:	853a                	mv	a0,a4
    ...
    19ea:	c0a50513          	addi	a0,a0,-1014 # 25f0 <release_queue>
...
struct threads_sched_result fill_sparse(struct threads_sched_args args) {
    ...
    1ab6:	faf42c23          	sw	a5,-72(s0)
    return r;    
    1aba:	fb043783          	ld	a5,-80(s0)
    1abe:	fcf43023          	sd	a5,-64(s0)
    1ac2:	fb843783          	ld	a5,-72(s0)
    1ac6:	fcf43423          	sd	a5,-56(s0)
    1aca:	4701                	li	a4,0
    1acc:	fc043703          	ld	a4,-64(s0)
    1ad0:	4781                	li	a5,0
    ...
    1ade:	853a                	mv	a0,a4
    1ae0:	85be                	mv	a1,a5
    1ae2:	6426                	ld	s0,72(sp)
    1ae4:	6486                	ld	s1,64(sp)
    1ae6:	6161                	addi	sp,sp,80
    1ae8:	8082                	ret

0000000000001aea <schedule_default>:

/* default scheduling algorithm */
struct threads_sched_result schedule_default(struct threads_sched_args args)
{
    1aea:	715d                	addi	sp,sp,-80
    1aec:	e4a2                	sd	s0,72(sp)
    1aee:	e0a6                	sd	s1,64(sp)
    1af0:	0880                	addi	s0,sp,80
    1af2:	84aa                	mv	s1,a0
    struct thread *thread_with_smallest_id = NULL;
    1af4:	fe043423          	sd	zero,-24(s0)
    struct thread *th = NULL;
    1af8:	fe043023          	sd	zero,-32(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    1afc:	649c                	ld	a5,8(s1)
    1afe:	639c                	ld	a5,0(a5)
    1b00:	fcf43c23          	sd	a5,-40(s0)
    1b04:	fd843783          	ld	a5,-40(s0)
    1b08:	fd878793          	addi	a5,a5,-40
    1b0c:	fef43023          	sd	a5,-32(s0)
    1b10:	a81d                	j	1b46 <schedule_default+0x5c>
        if (thread_with_smallest_id == NULL || th->ID < thread_with_smallest_id->ID)
    1b12:	fe843783          	ld	a5,-24(s0)
    1b16:	cb89                	beqz	a5,1b28 <schedule_default+0x3e>
    1b18:	fe043783          	ld	a5,-32(s0)
    1b1c:	5fd8                	lw	a4,60(a5)
    1b1e:	fe843783          	ld	a5,-24(s0)
    1b22:	5fdc                	lw	a5,60(a5)
    1b24:	00f75663          	bge	a4,a5,1b30 <schedule_default+0x46>
            thread_with_smallest_id = th;
    1b28:	fe043783          	ld	a5,-32(s0)
    1b2c:	fef43423          	sd	a5,-24(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    1b30:	fe043783          	ld	a5,-32(s0)
    1b34:	779c                	ld	a5,40(a5)
    1b36:	fcf43823          	sd	a5,-48(s0)
    1b3a:	fd043783          	ld	a5,-48(s0)
    1b3e:	fd878793          	addi	a5,a5,-40
    1b42:	fef43023          	sd	a5,-32(s0)
    1b46:	fe043783          	ld	a5,-32(s0)
    1b4a:	02878713          	addi	a4,a5,40
    1b4e:	649c                	ld	a5,8(s1)
    1b50:	fcf711e3          	bne	a4,a5,1b12 <schedule_default+0x28>
    }

    struct threads_sched_result r;
    if (thread_with_smallest_id != NULL) {
    1b54:	fe843783          	ld	a5,-24(s0)
    1b58:	cf89                	beqz	a5,1b72 <schedule_default+0x88>
        r.scheduled_thread_list_member = &thread_with_smallest_id->thread_list;
    1b5a:	fe843783          	ld	a5,-24(s0)
    1b5e:	02878793          	addi	a5,a5,40
    1b62:	faf43823          	sd	a5,-80(s0)
        r.allocated_time = thread_with_smallest_id->remaining_time;
    1b66:	fe843783          	ld	a5,-24(s0)
    1b6a:	4fbc                	lw	a5,88(a5)
    1b6c:	faf42c23          	sw	a5,-72(s0)
    1b70:	a039                	j	1b7e <schedule_default+0x94>
    } else {
        r.scheduled_thread_list_member = args.run_queue;
    1b72:	649c                	ld	a5,8(s1)
    1b74:	faf43823          	sd	a5,-80(s0)
        r.allocated_time = 1;
    1b78:	4785                	li	a5,1
    1b7a:	faf42c23          	sw	a5,-72(s0)
    }

    return r;
    1b7e:	fb043783          	ld	a5,-80(s0)
    1b82:	fcf43023          	sd	a5,-64(s0)
    1b86:	fb843783          	ld	a5,-72(s0)
    1b8a:	fcf43423          	sd	a5,-56(s0)
    1b8e:	4701                	li	a4,0
    1b90:	fc043703          	ld	a4,-64(s0)
    1b94:	4781                	li	a5,0
    1b96:	fc843783          	ld	a5,-56(s0)
    1b9a:	863a                	mv	a2,a4
    1b9c:	86be                	mv	a3,a5
    1b9e:	8732                	mv	a4,a2
    1ba0:	87b6                	mv	a5,a3
    ...
    1ba2:	853a                	mv	a0,a4
    1ba4:	85be                	mv	a1,a5
    1ba6:	6426                	ld	s0,72(sp)
    1ba8:	6486                	ld	s1,64(sp)
    1baa:	6161                	addi	sp,sp,80
    1bac:	8082                	ret

0000000000001bae <schedule_wrr>:

/* MP3 Part 1 - Non-Real-Time Scheduling */
/* Weighted-Round-Robin Scheduling */
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{   
    1bae:	7135                	addi	sp,sp,-160
    1bb0:	ed06                	sd	ra,152(sp)
    1bb2:	e922                	sd	s0,144(sp)
    1bb4:	e526                	sd	s1,136(sp)
    1bb6:	e14a                	sd	s2,128(sp)
    1bb8:	fcce                	sd	s3,120(sp)
    1bba:	1100                	addi	s0,sp,160
    1bbc:	84aa                	mv	s1,a0
    // TODO: implement the weighted round-robin scheduling algorithm
    if (list_empty(args.run_queue)) 
    1bbe:	649c                	ld	a5,8(s1)
    1bc0:	853e                	mv	a0,a5
    1bc2:	00000097          	auipc	ra,0x0
    1bc6:	e46080e7          	jalr	-442(ra) # 1a08 <list_empty>
    1bca:	87aa                	mv	a5,a0
    1bcc:	cb85                	beqz	a5,1bfc <schedule_wrr+0x4e>
        return fill_sparse(args);
    1bce:	609c                	ld	a5,0(s1)
    1bd0:	f6f43023          	sd	a5,-160(s0)
    1bd4:	649c                	ld	a5,8(s1)
    1bd6:	f6f43423          	sd	a5,-152(s0)
    1bda:	689c                	ld	a5,16(s1)
    1bdc:	f6f43823          	sd	a5,-144(s0)
    1be0:	f6040793          	addi	a5,s0,-160
    1be4:	853e                	mv	a0,a5
    1be6:	00000097          	auipc	ra,0x0
    1bea:	e4c080e7          	jalr	-436(ra) # 1a32 <fill_sparse>
    1bee:	872a                	mv	a4,a0
    1bf0:	87ae                	mv	a5,a1
    1bf2:	f8e43823          	sd	a4,-112(s0)
    1bf6:	f8f43c23          	sd	a5,-104(s0)
    1bfa:	a0c9                	j	1cbc <schedule_wrr+0x10e>

    struct thread *process_thread = NULL;
    1bfc:	fc043423          	sd	zero,-56(s0)
    struct thread *th = NULL;
    1c00:	fc043023          	sd	zero,-64(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    1c04:	649c                	ld	a5,8(s1)
    1c06:	639c                	ld	a5,0(a5)
    1c08:	faf43823          	sd	a5,-80(s0)
    1c0c:	fb043783          	ld	a5,-80(s0)
    1c10:	fd878793          	addi	a5,a5,-40
    1c14:	fcf43023          	sd	a5,-64(s0)
    1c18:	a025                	j	1c40 <schedule_wrr+0x92>
        if (process_thread == NULL) {
    1c1a:	fc843783          	ld	a5,-56(s0)
    1c1e:	e791                	bnez	a5,1c2a <schedule_wrr+0x7c>
            process_thread = th;
    1c20:	fc043783          	ld	a5,-64(s0)
    1c24:	fcf43423          	sd	a5,-56(s0)
            break;
    1c28:	a01d                	j	1c4e <schedule_wrr+0xa0>
    list_for_each_entry(th, args.run_queue, thread_list) {
    1c2a:	fc043783          	ld	a5,-64(s0)
    1c2e:	779c                	ld	a5,40(a5)
    1c30:	faf43423          	sd	a5,-88(s0)
    1c34:	fa843783          	ld	a5,-88(s0)
    1c38:	fd878793          	addi	a5,a5,-40
    1c3c:	fcf43023          	sd	a5,-64(s0)
    1c40:	fc043783          	ld	a5,-64(s0)
    1c44:	02878713          	addi	a4,a5,40
    1c48:	649c                	ld	a5,8(s1)
    1c4a:	fcf718e3          	bne	a4,a5,1c1a <schedule_wrr+0x6c>
        }
    }
    
    int time_quantum = args.time_quantum;
    1c4e:	40dc                	lw	a5,4(s1)
    1c50:	faf42223          	sw	a5,-92(s0)
    int executing_time = process_thread->remaining_time;
    1c54:	fc843783          	ld	a5,-56(s0)
    1c58:	4fbc                	lw	a5,88(a5)
    1c5a:	faf42e23          	sw	a5,-68(s0)
    if (process_thread->remaining_time > time_quantum * (process_thread->weight)) {
    1c5e:	fc843783          	ld	a5,-56(s0)
    1c62:	4fb4                	lw	a3,88(a5)
    1c64:	fc843783          	ld	a5,-56(s0)
    1c68:	47bc                	lw	a5,72(a5)
    1c6a:	fa442703          	lw	a4,-92(s0)
    1c6e:	02f707bb          	mulw	a5,a4,a5
    1c72:	2781                	sext.w	a5,a5
    1c74:	8736                	mv	a4,a3
    1c76:	00e7dc63          	bge	a5,a4,1c8e <schedule_wrr+0xe0>
        executing_time = time_quantum * (process_thread->weight);
    1c7a:	fc843783          	ld	a5,-56(s0)
    1c7e:	47bc                	lw	a5,72(a5)
    1c80:	fa442703          	lw	a4,-92(s0)
    1c84:	02f707bb          	mulw	a5,a4,a5
    1c88:	faf42e23          	sw	a5,-68(s0)
    1c8c:	a031                	j	1c98 <schedule_wrr+0xea>
    }
    else {
        executing_time = process_thread->remaining_time;
    1c8e:	fc843783          	ld	a5,-56(s0)
    1c92:	4fbc                	lw	a5,88(a5)
    1c94:	faf42e23          	sw	a5,-68(s0)
    }
    
    struct threads_sched_result r;
    r.scheduled_thread_list_member = &process_thread->thread_list;
    1c98:	fc843783          	ld	a5,-56(s0)
    1c9c:	02878793          	addi	a5,a5,40
    1ca0:	f8f43023          	sd	a5,-128(s0)
    r.allocated_time = executing_time;
    1ca4:	fbc42783          	lw	a5,-68(s0)
    1ca8:	f8f42423          	sw	a5,-120(s0)
    return r;
    1cac:	f8043783          	ld	a5,-128(s0)
    1cb0:	f8f43823          	sd	a5,-112(s0)
    1cb4:	f8843783          	ld	a5,-120(s0)
    1cb8:	f8f43c23          	sd	a5,-104(s0)
    1cbc:	4701                	li	a4,0
    1cbe:	f9043703          	ld	a4,-112(s0)
    1cc2:	4781                	li	a5,0
    ...
    1cd0:	853a                	mv	a0,a4
    1cd2:	85be                	mv	a1,a5
    1cd4:	60ea                	ld	ra,152(sp)
    1cd6:	644a                	ld	s0,144(sp)
    1cd8:	64aa                	ld	s1,136(sp)
    1cda:	690a                	ld	s2,128(sp)
    1cdc:	79e6                	ld	s3,120(sp)
    1cde:	610d                	addi	sp,sp,160
    1ce0:	8082                	ret

0000000000001ce2 <schedule_sjf>:

/* Shortest-Job-First Scheduling */
struct threads_sched_result schedule_sjf(struct threads_sched_args args)
{   
    1ce2:	7131                	addi	sp,sp,-192
    1ce4:	fd06                	sd	ra,184(sp)
    1ce6:	f922                	sd	s0,176(sp)
    1ce8:	f526                	sd	s1,168(sp)
    1cea:	f14a                	sd	s2,160(sp)
    1cec:	ed4e                	sd	s3,152(sp)
    1cee:	0180                	addi	s0,sp,192
    1cf0:	84aa                	mv	s1,a0
    ...
    1cfa:	d12080e7          	jalr	-750(ra) # 1a08 <list_empty>
    1cfe:	87aa                	mv	a5,a0
    1d00:	cb85                	beqz	a5,1d30 <schedule_sjf+0x4e>
        return fill_sparse(args);
    1d02:	609c                	ld	a5,0(s1)
    1d04:	f4f43023          	sd	a5,-192(s0)
    1d08:	649c                	ld	a5,8(s1)
    1d0a:	f4f43423          	sd	a5,-184(s0)
    1d0e:	689c                	ld	a5,16(s1)
    1d10:	f4f43823          	sd	a5,-176(s0)
    1d14:	f4040793          	addi	a5,s0,-192
    1d18:	853e                	mv	a0,a5
    1d1a:	00000097          	auipc	ra,0x0
    1d1e:	d18080e7          	jalr	-744(ra) # 1a32 <fill_sparse>
    1d22:	872a                	mv	a4,a0
    1d24:	87ae                	mv	a5,a1
    1d26:	f6e43c23          	sd	a4,-136(s0)
    1d2a:	f8f43023          	sd	a5,-128(s0)
    1d2e:	aa49                	j	1ec0 <schedule_sjf+0x1de>

    int current_time = args.current_time;
    1d30:	409c                	lw	a5,0(s1)
    1d32:	faf42823          	sw	a5,-80(s0)

    // find the shortest thread in the run queue
    struct thread *shortest_thread = NULL;
    1d36:	fc043423          	sd	zero,-56(s0)
    struct thread *th = NULL;
    1d3a:	fc043023          	sd	zero,-64(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    1d3e:	649c                	ld	a5,8(s1)
    1d40:	639c                	ld	a5,0(a5)
    1d42:	faf43423          	sd	a5,-88(s0)
    1d46:	fa843783          	ld	a5,-88(s0)
    1d4a:	fd878793          	addi	a5,a5,-40
    1d4e:	fcf43023          	sd	a5,-64(s0)
    1d52:	a085                	j	1db2 <schedule_sjf+0xd0>
        if (shortest_thread == NULL || th->remaining_time < shortest_thread->remaining_time) {
    1d54:	fc843783          	ld	a5,-56(s0)
    1d58:	cb89                	beqz	a5,1d6a <schedule_sjf+0x88>
    1d5a:	fc043783          	ld	a5,-64(s0)
    1d5e:	4fb8                	lw	a4,88(a5)
    1d60:	fc843783          	ld	a5,-56(s0)
    1d64:	4fbc                	lw	a5,88(a5)
    1d66:	00f75763          	bge	a4,a5,1d74 <schedule_sjf+0x92>
            shortest_thread = th;
    1d6a:	fc043783          	ld	a5,-64(s0)
    1d6e:	fcf43423          	sd	a5,-56(s0)
    1d72:	a02d                	j	1d9c <schedule_sjf+0xba>
        }
        else if (th->remaining_time == shortest_thread->remaining_time && th->ID < shortest_thread->ID) {
    1d74:	fc043783          	ld	a5,-64(s0)
    1d78:	4fb8                	lw	a4,88(a5)
    1d7a:	fc843783          	ld	a5,-56(s0)
    1d7e:	4fbc                	lw	a5,88(a5)
    1d80:	00f71e63          	bne	a4,a5,1d9c <schedule_sjf+0xba>
    1d84:	fc043783          	ld	a5,-64(s0)
    1d88:	5fd8                	lw	a4,60(a5)
    1d8a:	fc843783          	ld	a5,-56(s0)
    1d8e:	5fdc                	lw	a5,60(a5)
    1d90:	00f75663          	bge	a4,a5,1d9c <schedule_sjf+0xba>
            shortest_thread = th;
    1d94:	fc043783          	ld	a5,-64(s0)
    1d98:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    1d9c:	fc043783          	ld	a5,-64(s0)
    1da0:	779c                	ld	a5,40(a5)
    1da2:	f8f43423          	sd	a5,-120(s0)
    1da6:	f8843783          	ld	a5,-120(s0)
    1daa:	fd878793          	addi	a5,a5,-40
    1dae:	fcf43023          	sd	a5,-64(s0)
    1db2:	fc043783          	ld	a5,-64(s0)
    1db6:	02878713          	addi	a4,a5,40
    1dba:	649c                	ld	a5,8(s1)
    1dbc:	f8f71ce3          	bne	a4,a5,1d54 <schedule_sjf+0x72>
        }
    }
    ...
    1dc4:	4fbc                	lw	a5,88(a5)
    1dc6:	faf42a23          	sw	a5,-76(s0)
    list_for_each_entry(cur, args.release_queue, thread_list) {
    1dca:	689c                	ld	a5,16(s1)
    1dcc:	639c                	ld	a5,0(a5)
    1dce:	faf43023          	sd	a5,-96(s0)
    1dd2:	fa043783          	ld	a5,-96(s0)
    1dd6:	17e1                	addi	a5,a5,-8
    1dd8:	faf43c23          	sd	a5,-72(s0)
    1ddc:	a84d                	j	1e8e <schedule_sjf+0x1ac>
        int interval = cur->release_time - current_time;
    1dde:	fb843783          	ld	a5,-72(s0)
    1de2:	4f98                	lw	a4,24(a5)
    1de4:	fb042783          	lw	a5,-80(s0)
    1de8:	40f707bb          	subw	a5,a4,a5
    1dec:	f8f42e23          	sw	a5,-100(s0)
        if (interval > executing_time) continue;
    1df0:	f9c42703          	lw	a4,-100(s0)
    1df4:	fb442783          	lw	a5,-76(s0)
    1df8:	2701                	sext.w	a4,a4
    1dfa:	2781                	sext.w	a5,a5
    1dfc:	06e7c863          	blt	a5,a4,1e6c <schedule_sjf+0x18a>
        if (current_time + shortest_thread->remaining_time < cur->release_time ) continue; 
    1e00:	fc843783          	ld	a5,-56(s0)
    1e04:	4fbc                	lw	a5,88(a5)
    1e06:	fb042703          	lw	a4,-80(s0)
    1e0a:	9fb9                	addw	a5,a5,a4
    1e0c:	0007871b          	sext.w	a4,a5
    1e10:	fb843783          	ld	a5,-72(s0)
    1e14:	4f9c                	lw	a5,24(a5)
    1e16:	04f74d63          	blt	a4,a5,1e70 <schedule_sjf+0x18e>
        int remaining_time = shortest_thread->remaining_time - interval;
    1e1a:	fc843783          	ld	a5,-56(s0)
    1e1e:	4fb8                	lw	a4,88(a5)
    1e20:	f9c42783          	lw	a5,-100(s0)
    1e24:	40f707bb          	subw	a5,a4,a5
    1e28:	f8f42c23          	sw	a5,-104(s0)
        if (remaining_time < cur->thrd->processing_time) continue;
    1e2c:	fb843783          	ld	a5,-72(s0)
    1e30:	639c                	ld	a5,0(a5)
    1e32:	43f8                	lw	a4,68(a5)
    1e34:	f9842783          	lw	a5,-104(s0)
    1e38:	2781                	sext.w	a5,a5
    1e3a:	02e7cd63          	blt	a5,a4,1e74 <schedule_sjf+0x192>
        if (remaining_time == cur->thrd->processing_time && shortest_thread->ID < cur->thrd->ID) continue;
    1e3e:	fb843783          	ld	a5,-72(s0)
    1e42:	639c                	ld	a5,0(a5)
    1e44:	43f8                	lw	a4,68(a5)
    1e46:	f9842783          	lw	a5,-104(s0)
    1e4a:	2781                	sext.w	a5,a5
    1e4c:	00e79b63          	bne	a5,a4,1e62 <schedule_sjf+0x180>
    1e50:	fc843783          	ld	a5,-56(s0)
    1e54:	5fd8                	lw	a4,60(a5)
    1e56:	fb843783          	ld	a5,-72(s0)
    1e5a:	639c                	ld	a5,0(a5)
    1e5c:	5fdc                	lw	a5,60(a5)
    1e5e:	00f74d63          	blt	a4,a5,1e78 <schedule_sjf+0x196>
        executing_time = interval;
    1e62:	f9c42783          	lw	a5,-100(s0)
    1e66:	faf42a23          	sw	a5,-76(s0)
    1e6a:	a801                	j	1e7a <schedule_sjf+0x198>
        if (interval > executing_time) continue;
    1e6c:	0001                	nop
    1e6e:	a031                	j	1e7a <schedule_sjf+0x198>
        if (current_time + shortest_thread->remaining_time < cur->release_time ) continue; 
    1e70:	0001                	nop
    1e72:	a021                	j	1e7a <schedule_sjf+0x198>
        if (remaining_time < cur->thrd->processing_time) continue;
    1e74:	0001                	nop
    1e76:	a011                	j	1e7a <schedule_sjf+0x198>
        if (remaining_time == cur->thrd->processing_time && shortest_thread->ID < cur->thrd->ID) continue;
    1e78:	0001                	nop
    list_for_each_entry(cur, args.release_queue, thread_list) {
    1e7a:	fb843783          	ld	a5,-72(s0)
    1e7e:	679c                	ld	a5,8(a5)
    1e80:	f8f43823          	sd	a5,-112(s0)
    1e84:	f9043783          	ld	a5,-112(s0)
    1e88:	17e1                	addi	a5,a5,-8
    1e8a:	faf43c23          	sd	a5,-72(s0)
    1e8e:	fb843783          	ld	a5,-72(s0)
    1e92:	00878713          	addi	a4,a5,8
    1e96:	689c                	ld	a5,16(s1)
    1e98:	f4f713e3          	bne	a4,a5,1dde <schedule_sjf+0xfc>
    }

    struct threads_sched_result r;
    r.scheduled_thread_list_member = &shortest_thread->thread_list;
    1e9c:	fc843783          	ld	a5,-56(s0)
    1ea0:	02878793          	addi	a5,a5,40
    1ea4:	f6f43423          	sd	a5,-152(s0)
    r.allocated_time = executing_time;
    1ea8:	fb442783          	lw	a5,-76(s0)
    1eac:	f6f42823          	sw	a5,-144(s0)
    return r;
    1eb0:	f6843783          	ld	a5,-152(s0)
    1eb4:	f6f43c23          	sd	a5,-136(s0)
    1eb8:	f7043783          	ld	a5,-144(s0)
    1ebc:	f8f43023          	sd	a5,-128(s0)
    1ec0:	4701                	li	a4,0
    1ec2:	f7843703          	ld	a4,-136(s0)
    1ec6:	4781                	li	a5,0
    1ec8:	f8043783          	ld	a5,-128(s0)
    1ecc:	893a                	mv	s2,a4
    1ece:	89be                	mv	s3,a5
    1ed0:	874a                	mv	a4,s2
    1ed2:	87ce                	mv	a5,s3
    ...
    1ed4:	853a                	mv	a0,a4
    1ed6:	85be                	mv	a1,a5
    1ed8:	70ea                	ld	ra,184(sp)
    1eda:	744a                	ld	s0,176(sp)
    1edc:	74aa                	ld	s1,168(sp)
    1ede:	790a                	ld	s2,160(sp)
    1ee0:	69ea                	ld	s3,152(sp)
    1ee2:	6129                	addi	sp,sp,192
    1ee4:	8082                	ret

0000000000001ee6 <schedule_lst>:

/* MP3 Part 2 - Real-Time Scheduling*/
/* Least-Slack-Time Scheduling */
struct threads_sched_result schedule_lst(struct threads_sched_args args)
{
    1ee6:	7115                	addi	sp,sp,-224
    1ee8:	ed86                	sd	ra,216(sp)
    1eea:	e9a2                	sd	s0,208(sp)
    1eec:	e5a6                	sd	s1,200(sp)
    1eee:	e1ca                	sd	s2,192(sp)
    1ef0:	fd4e                	sd	s3,184(sp)
    1ef2:	1180                	addi	s0,sp,224
    1ef4:	84aa                	mv	s1,a0
    ...
    if (list_empty(args.run_queue)) 
    1ef6:	649c                	ld	a5,8(s1)
    1ef8:	853e                	mv	a0,a5
    1efa:	00000097          	auipc	ra,0x0
    1efe:	b0e080e7          	jalr	-1266(ra) # 1a08 <list_empty>
    1f02:	87aa                	mv	a5,a0
    1f04:	cb85                	beqz	a5,1f34 <schedule_lst+0x4e>
        return fill_sparse(args);
    1f06:	609c                	ld	a5,0(s1)
    1f08:	f2f43023          	sd	a5,-224(s0)
    1f0c:	649c                	ld	a5,8(s1)
    1f0e:	f2f43423          	sd	a5,-216(s0)
    1f12:	689c                	ld	a5,16(s1)
    1f14:	f2f43823          	sd	a5,-208(s0)
    1f18:	f2040793          	addi	a5,s0,-224
    1f1c:	853e                	mv	a0,a5
    1f1e:	00000097          	auipc	ra,0x0
    1f22:	b14080e7          	jalr	-1260(ra) # 1a32 <fill_sparse>
    1f26:	872a                	mv	a4,a0
    1f28:	87ae                	mv	a5,a1
    1f2a:	f6e43023          	sd	a4,-160(s0)
    1f2e:	f6f43423          	sd	a5,-152(s0)
    1f32:	ac41                	j	21c2 <schedule_lst+0x2dc>

    int current_time = args.current_time;
    1f34:	409c                	lw	a5,0(s1)
    1f36:	faf42623          	sw	a5,-84(s0)

    // find the thread with the least slack time
    struct thread *least_slack_thread = NULL;
    1f3a:	fc043423          	sd	zero,-56(s0)
    struct thread *th = NULL;
    1f3e:	fc043023          	sd	zero,-64(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    1f42:	649c                	ld	a5,8(s1)
    1f44:	639c                	ld	a5,0(a5)
    1f46:	faf43023          	sd	a5,-96(s0)
    1f4a:	fa043783          	ld	a5,-96(s0)
    1f4e:	fd878793          	addi	a5,a5,-40
    1f52:	fcf43023          	sd	a5,-64(s0)
    1f56:	a239                	j	2064 <schedule_lst+0x17e>
        int slack_time = th->current_deadline - current_time - th->remaining_time;
    1f58:	fc043783          	ld	a5,-64(s0)
    1f5c:	4ff8                	lw	a4,92(a5)
    1f5e:	fac42783          	lw	a5,-84(s0)
    1f62:	40f707bb          	subw	a5,a4,a5
    1f66:	0007871b          	sext.w	a4,a5
    1f6a:	fc043783          	ld	a5,-64(s0)
    1f6e:	4fbc                	lw	a5,88(a5)
    1f70:	40f707bb          	subw	a5,a4,a5
    1f74:	f6f42e23          	sw	a5,-132(s0)
    ...
    1f78:	fc843783          	ld	a5,-56(s0)
    1f7c:	c38d                	beqz	a5,1f9e <schedule_lst+0xb8>
    1f7e:	fc843783          	ld	a5,-56(s0)
    1f82:	4ff8                	lw	a4,92(a5)
    1f84:	fac42783          	lw	a5,-84(s0)
    1f88:	40f707bb          	subw	a5,a4,a5
    1f8c:	0007871b          	sext.w	a4,a5
    1f90:	fc843783          	ld	a5,-56(s0)
    1f94:	4fbc                	lw	a5,88(a5)
    1f96:	40f707bb          	subw	a5,a4,a5
    1f9a:	2781                	sext.w	a5,a5
    1f9c:	a011                	j	1fa0 <schedule_lst+0xba>
    1f9e:	4781                	li	a5,0
    1fa0:	f6f42c23          	sw	a5,-136(s0)
        if (least_slack_thread == NULL) {
    1fa4:	fc843783          	ld	a5,-56(s0)
    1fa8:	e791                	bnez	a5,1fb4 <schedule_lst+0xce>
            least_slack_thread = th;
    1faa:	fc043783          	ld	a5,-64(s0)
    1fae:	fcf43423          	sd	a5,-56(s0)
    1fb2:	a871                	j	204e <schedule_lst+0x168>
        }
        else if (least_slack_thread->current_deadline <= current_time) { // missing the deadline
    1fb4:	fc843783          	ld	a5,-56(s0)
    1fb8:	4ff8                	lw	a4,92(a5)
    1fba:	fac42783          	lw	a5,-84(s0)
    1fbe:	2781                	sext.w	a5,a5
    1fc0:	02e7c763          	blt	a5,a4,1fee <schedule_lst+0x108>
            if (th->current_deadline > current_time) continue;
    1fc4:	fc043783          	ld	a5,-64(s0)
    1fc8:	4ff8                	lw	a4,92(a5)
    1fca:	fac42783          	lw	a5,-84(s0)
    1fce:	2781                	sext.w	a5,a5
    1fd0:	06e7ce63          	blt	a5,a4,204c <schedule_lst+0x166>
            if (th->ID < least_slack_thread->ID) {
    1fd4:	fc043783          	ld	a5,-64(s0)
    1fd8:	5fd8                	lw	a4,60(a5)
    1fda:	fc843783          	ld	a5,-56(s0)
    1fde:	5fdc                	lw	a5,60(a5)
    1fe0:	06f75763          	bge	a4,a5,204e <schedule_lst+0x168>
                least_slack_thread = th;
    1fe4:	fc043783          	ld	a5,-64(s0)
    1fe8:	fcf43423          	sd	a5,-56(s0)
    1fec:	a08d                	j	204e <schedule_lst+0x168>
            }
        }
        else if (th->current_deadline <= current_time) {
    1fee:	fc043783          	ld	a5,-64(s0)
    1ff2:	4ff8                	lw	a4,92(a5)
    1ff4:	fac42783          	lw	a5,-84(s0)
    1ff8:	2781                	sext.w	a5,a5
    1ffa:	00e7c763          	blt	a5,a4,2008 <schedule_lst+0x122>
            least_slack_thread = th;
    1ffe:	fc043783          	ld	a5,-64(s0)
    2002:	fcf43423          	sd	a5,-56(s0)
    2006:	a0a1                	j	204e <schedule_lst+0x168>
        }
        else if (slack_time < least_slack_time) {
    2008:	f7c42703          	lw	a4,-132(s0)
    200c:	f7842783          	lw	a5,-136(s0)
    2010:	2701                	sext.w	a4,a4
    2012:	2781                	sext.w	a5,a5
    2014:	00f75763          	bge	a4,a5,2022 <schedule_lst+0x13c>
            least_slack_thread = th;
    2018:	fc043783          	ld	a5,-64(s0)
    201c:	fcf43423          	sd	a5,-56(s0)
    2020:	a03d                	j	204e <schedule_lst+0x168>
        }
        else if (slack_time == least_slack_time && th->ID < least_slack_thread->ID) {
    2022:	f7c42703          	lw	a4,-132(s0)
    2026:	f7842783          	lw	a5,-136(s0)
    202a:	2701                	sext.w	a4,a4
    202c:	2781                	sext.w	a5,a5
    202e:	02f71063          	bne	a4,a5,204e <schedule_lst+0x168>
    2032:	fc043783          	ld	a5,-64(s0)
    2036:	5fd8                	lw	a4,60(a5)
    2038:	fc843783          	ld	a5,-56(s0)
    203c:	5fdc                	lw	a5,60(a5)
    203e:	00f75863          	bge	a4,a5,204e <schedule_lst+0x168>
            least_slack_thread = th;
    2042:	fc043783          	ld	a5,-64(s0)
    2046:	fcf43423          	sd	a5,-56(s0)
    204a:	a011                	j	204e <schedule_lst+0x168>
            if (th->current_deadline > current_time) continue;
    204c:	0001                	nop
    list_for_each_entry(th, args.run_queue, thread_list) {
    204e:	fc043783          	ld	a5,-64(s0)
    2052:	779c                	ld	a5,40(a5)
    2054:	f6f43823          	sd	a5,-144(s0)
    2058:	f7043783          	ld	a5,-144(s0)
    205c:	fd878793          	addi	a5,a5,-40
    2060:	fcf43023          	sd	a5,-64(s0)
    2064:	fc043783          	ld	a5,-64(s0)
    2068:	02878713          	addi	a4,a5,40
    206c:	649c                	ld	a5,8(s1)
    206e:	eef715e3          	bne	a4,a5,1f58 <schedule_lst+0x72>
        }
    }

    // all thread missing the current deadline
    if (least_slack_thread->current_deadline <= current_time)
    2072:	fc843783          	ld	a5,-56(s0)
    2076:	4ff8                	lw	a4,92(a5)
    2078:	fac42783          	lw	a5,-84(s0)
    207c:	2781                	sext.w	a5,a5
    207e:	00e7cb63          	blt	a5,a4,2094 <schedule_lst+0x1ae>
    ...
    2086:	02878793          	addi	a5,a5,40
    208a:	f6f43023          	sd	a5,-160(s0)
    208e:	f6042423          	sw	zero,-152(s0)
    2092:	aa05                	j	21c2 <schedule_lst+0x2dc>
    
    int executing_time = least_slack_thread->remaining_time;
    2094:	fc843783          	ld	a5,-56(s0)
    2098:	4fbc                	lw	a5,88(a5)
    209a:	faf42e23          	sw	a5,-68(s0)
    ...
    20a2:	4fb4                	lw	a3,88(a5)
    20a4:	fc843783          	ld	a5,-56(s0)
    20a8:	4ff8                	lw	a4,92(a5)
    20aa:	fac42783          	lw	a5,-84(s0)
    20ae:	40f707bb          	subw	a5,a4,a5
    20b2:	2781                	sext.w	a5,a5
    20b4:	8736                	mv	a4,a3
    20b6:	00e7db63          	bge	a5,a4,20cc <schedule_lst+0x1e6>
        executing_time = least_slack_thread->current_deadline - current_time;
    20ba:	fc843783          	ld	a5,-56(s0)
    20be:	4ff8                	lw	a4,92(a5)
    20c0:	fac42783          	lw	a5,-84(s0)
    20c4:	40f707bb          	subw	a5,a4,a5
    20c8:	faf42e23          	sw	a5,-68(s0)
    ...
    20d0:	4ff8                	lw	a4,92(a5)
    20d2:	fac42783          	lw	a5,-84(s0)
    20d6:	40f707bb          	subw	a5,a4,a5
    20da:	0007871b          	sext.w	a4,a5
    20de:	fc843783          	ld	a5,-56(s0)
    20e2:	4fbc                	lw	a5,88(a5)
    20e4:	40f707bb          	subw	a5,a4,a5
    20e8:	f8f42e23          	sw	a5,-100(s0)
    list_for_each_entry(cur, args.release_queue, thread_list) {
    20ec:	689c                	ld	a5,16(s1)
    20ee:	639c                	ld	a5,0(a5)
    20f0:	f8f43823          	sd	a5,-112(s0)
    20f4:	f9043783          	ld	a5,-112(s0)
    20f8:	17e1                	addi	a5,a5,-8
    20fa:	faf43823          	sd	a5,-80(s0)
    20fe:	a849                	j	2190 <schedule_lst+0x2aa>
        int cur_slack_time = cur->thrd->deadline - cur->thrd->processing_time;
    2100:	fb043783          	ld	a5,-80(s0)
    2104:	639c                	ld	a5,0(a5)
    2106:	47f8                	lw	a4,76(a5)
    2108:	fb043783          	ld	a5,-80(s0)
    210c:	639c                	ld	a5,0(a5)
    210e:	43fc                	lw	a5,68(a5)
    2110:	40f707bb          	subw	a5,a4,a5
    2114:	f8f42623          	sw	a5,-116(s0)
        int interval = cur->release_time - current_time;
    2118:	fb043783          	ld	a5,-80(s0)
    211c:	4f98                	lw	a4,24(a5)
    211e:	fac42783          	lw	a5,-84(s0)
    2122:	40f707bb          	subw	a5,a4,a5
    2126:	f8f42423          	sw	a5,-120(s0)
        if (interval > executing_time || slack_time < cur_slack_time) continue;
    212a:	f8842703          	lw	a4,-120(s0)
    212e:	fbc42783          	lw	a5,-68(s0)
    2132:	2701                	sext.w	a4,a4
    2134:	2781                	sext.w	a5,a5
    2136:	04e7c063          	blt	a5,a4,2176 <schedule_lst+0x290>
    213a:	f9c42703          	lw	a4,-100(s0)
    213e:	f8c42783          	lw	a5,-116(s0)
    2142:	2701                	sext.w	a4,a4
    2144:	2781                	sext.w	a5,a5
    2146:	02f74863          	blt	a4,a5,2176 <schedule_lst+0x290>
        if (slack_time == cur_slack_time && least_slack_thread->ID < cur->thrd->ID) continue;
    214a:	f9c42703          	lw	a4,-100(s0)
    214e:	f8c42783          	lw	a5,-116(s0)
    2152:	2701                	sext.w	a4,a4
    2154:	2781                	sext.w	a5,a5
    2156:	00f71b63          	bne	a4,a5,216c <schedule_lst+0x286>
    215a:	fc843783          	ld	a5,-56(s0)
    215e:	5fd8                	lw	a4,60(a5)
    2160:	fb043783          	ld	a5,-80(s0)
    2164:	639c                	ld	a5,0(a5)
    2166:	5fdc                	lw	a5,60(a5)
    2168:	00f74963          	blt	a4,a5,217a <schedule_lst+0x294>
        executing_time = interval;
    216c:	f8842783          	lw	a5,-120(s0)
    2170:	faf42e23          	sw	a5,-68(s0)
    2174:	a021                	j	217c <schedule_lst+0x296>
        if (interval > executing_time || slack_time < cur_slack_time) continue;
    2176:	0001                	nop
    2178:	a011                	j	217c <schedule_lst+0x296>
        if (slack_time == cur_slack_time && least_slack_thread->ID < cur->thrd->ID) continue;
    217a:	0001                	nop
    list_for_each_entry(cur, args.release_queue, thread_list) {
    217c:	fb043783          	ld	a5,-80(s0)
    2180:	679c                	ld	a5,8(a5)
    2182:	f8f43023          	sd	a5,-128(s0)
    2186:	f8043783          	ld	a5,-128(s0)
    218a:	17e1                	addi	a5,a5,-8
    218c:	faf43823          	sd	a5,-80(s0)
    2190:	fb043783          	ld	a5,-80(s0)
    2194:	00878713          	addi	a4,a5,8
    2198:	689c                	ld	a5,16(s1)
    219a:	f6f713e3          	bne	a4,a5,2100 <schedule_lst+0x21a>
    }

    struct threads_sched_result r;
    r.scheduled_thread_list_member = &least_slack_thread->thread_list;
    219e:	fc843783          	ld	a5,-56(s0)
    21a2:	02878793          	addi	a5,a5,40
    21a6:	f4f43823          	sd	a5,-176(s0)
    r.allocated_time = executing_time;
    21aa:	fbc42783          	lw	a5,-68(s0)
    21ae:	f4f42c23          	sw	a5,-168(s0)
    return r;
    21b2:	f5043783          	ld	a5,-176(s0)
    21b6:	f6f43023          	sd	a5,-160(s0)
    21ba:	f5843783          	ld	a5,-168(s0)
    21be:	f6f43423          	sd	a5,-152(s0)
    21c2:	4701                	li	a4,0
    21c4:	f6043703          	ld	a4,-160(s0)
    21c8:	4781                	li	a5,0
    21ca:	f6843783          	ld	a5,-152(s0)
    21ce:	893a                	mv	s2,a4
    21d0:	89be                	mv	s3,a5
    21d2:	874a                	mv	a4,s2
    21d4:	87ce                	mv	a5,s3
    ...
    21d6:	853a                	mv	a0,a4
    21d8:	85be                	mv	a1,a5
    21da:	60ee                	ld	ra,216(sp)
    21dc:	644e                	ld	s0,208(sp)
    21de:	64ae                	ld	s1,200(sp)
    21e0:	690e                	ld	s2,192(sp)
    21e2:	79ea                	ld	s3,184(sp)
    21e4:	612d                	addi	sp,sp,224
    21e6:	8082                	ret

00000000000021e8 <schedule_dm>:

/* Deadline-Monotonic Scheduling */
struct threads_sched_result schedule_dm(struct threads_sched_args args)
{
    21e8:	7155                	addi	sp,sp,-208
    21ea:	e586                	sd	ra,200(sp)
    21ec:	e1a2                	sd	s0,192(sp)
    21ee:	fd26                	sd	s1,184(sp)
    21f0:	f94a                	sd	s2,176(sp)
    21f2:	f54e                	sd	s3,168(sp)
    21f4:	0980                	addi	s0,sp,208
    21f6:	84aa                	mv	s1,a0
    ...
    // no thread in the run queue
    if (list_empty(args.run_queue)) 
    21f8:	649c                	ld	a5,8(s1)
    21fa:	853e                	mv	a0,a5
    21fc:	00000097          	auipc	ra,0x0
    2200:	80c080e7          	jalr	-2036(ra) # 1a08 <list_empty>
    2204:	87aa                	mv	a5,a0
    2206:	cb85                	beqz	a5,2236 <schedule_dm+0x4e>
        return fill_sparse(args);
    2208:	609c                	ld	a5,0(s1)
    220a:	f2f43823          	sd	a5,-208(s0)
    220e:	649c                	ld	a5,8(s1)
    2210:	f2f43c23          	sd	a5,-200(s0)
    2214:	689c                	ld	a5,16(s1)
    2216:	f4f43023          	sd	a5,-192(s0)
    221a:	f3040793          	addi	a5,s0,-208
    221e:	853e                	mv	a0,a5
    2220:	00000097          	auipc	ra,0x0
    2224:	812080e7          	jalr	-2030(ra) # 1a32 <fill_sparse>
    2228:	872a                	mv	a4,a0
    222a:	87ae                	mv	a5,a1
    222c:	f6e43823          	sd	a4,-144(s0)
    2230:	f6f43c23          	sd	a5,-136(s0)
    2234:	ac11                	j	2448 <schedule_dm+0x260>
    
    int current_time = args.current_time;
    2236:	409c                	lw	a5,0(s1)
    2238:	faf42623          	sw	a5,-84(s0)

    // find the thread with the earliest deadline
    struct thread *highest_priority_thread = NULL;
    223c:	fc043423          	sd	zero,-56(s0)
    struct thread *th = NULL;
    2240:	fc043023          	sd	zero,-64(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    2244:	649c                	ld	a5,8(s1)
    2246:	639c                	ld	a5,0(a5)
    2248:	faf43023          	sd	a5,-96(s0)
    224c:	fa043783          	ld	a5,-96(s0)
    2250:	fd878793          	addi	a5,a5,-40
    2254:	fcf43023          	sd	a5,-64(s0)
    2258:	a0c9                	j	231a <schedule_dm+0x132>
        if (highest_priority_thread == NULL) {
    225a:	fc843783          	ld	a5,-56(s0)
    225e:	e791                	bnez	a5,226a <schedule_dm+0x82>
            highest_priority_thread = th;
    2260:	fc043783          	ld	a5,-64(s0)
    2264:	fcf43423          	sd	a5,-56(s0)
    2268:	a871                	j	2304 <schedule_dm+0x11c>
        }
        else if (highest_priority_thread->current_deadline <= current_time) { // missing the deadline
    226a:	fc843783          	ld	a5,-56(s0)
    226e:	4ff8                	lw	a4,92(a5)
    2270:	fac42783          	lw	a5,-84(s0)
    2274:	2781                	sext.w	a5,a5
    2276:	02e7c763          	blt	a5,a4,22a4 <schedule_dm+0xbc>
            if (th->current_deadline > current_time) continue;
    227a:	fc043783          	ld	a5,-64(s0)
    227e:	4ff8                	lw	a4,92(a5)
    2280:	fac42783          	lw	a5,-84(s0)
    2284:	2781                	sext.w	a5,a5
    2286:	06e7ce63          	blt	a5,a4,2302 <schedule_dm+0x11a>
            if (th->ID < highest_priority_thread->ID) {
    228a:	fc043783          	ld	a5,-64(s0)
    228e:	5fd8                	lw	a4,60(a5)
    2290:	fc843783          	ld	a5,-56(s0)
    2294:	5fdc                	lw	a5,60(a5)
    2296:	06f75763          	bge	a4,a5,2304 <schedule_dm+0x11c>
                highest_priority_thread = th;
    229a:	fc043783          	ld	a5,-64(s0)
    229e:	fcf43423          	sd	a5,-56(s0)
    22a2:	a08d                	j	2304 <schedule_dm+0x11c>
            }
        }
        else if (th->current_deadline <= current_time) {
    ...
    22b0:	00e7c763          	blt	a5,a4,22be <schedule_dm+0xd6>
            highest_priority_thread = th;
    22b4:	fc043783          	ld	a5,-64(s0)
    22b8:	fcf43423          	sd	a5,-56(s0)
    22bc:	a0a1                	j	2304 <schedule_dm+0x11c>
        }
        else if (th->deadline < highest_priority_thread->deadline ) {
    22be:	fc043783          	ld	a5,-64(s0)
    22c2:	47f8                	lw	a4,76(a5)
    22c4:	fc843783          	ld	a5,-56(s0)
    22c8:	47fc                	lw	a5,76(a5)
    22ca:	00f75763          	bge	a4,a5,22d8 <schedule_dm+0xf0>
            highest_priority_thread = th;
    22ce:	fc043783          	ld	a5,-64(s0)
    22d2:	fcf43423          	sd	a5,-56(s0)
    22d6:	a03d                	j	2304 <schedule_dm+0x11c>
        }
        else if (th->deadline == highest_priority_thread->deadline && th->ID < highest_priority_thread->ID) {
    22d8:	fc043783          	ld	a5,-64(s0)
    22dc:	47f8                	lw	a4,76(a5)
    22de:	fc843783          	ld	a5,-56(s0)
    22e2:	47fc                	lw	a5,76(a5)
    22e4:	02f71063          	bne	a4,a5,2304 <schedule_dm+0x11c>
    22e8:	fc043783          	ld	a5,-64(s0)
    22ec:	5fd8                	lw	a4,60(a5)
    22ee:	fc843783          	ld	a5,-56(s0)
    22f2:	5fdc                	lw	a5,60(a5)
    22f4:	00f75863          	bge	a4,a5,2304 <schedule_dm+0x11c>
            highest_priority_thread = th;
    22f8:	fc043783          	ld	a5,-64(s0)
    22fc:	fcf43423          	sd	a5,-56(s0)
    2300:	a011                	j	2304 <schedule_dm+0x11c>
            if (th->current_deadline > current_time) continue;
    2302:	0001                	nop
    list_for_each_entry(th, args.run_queue, thread_list) {
    2304:	fc043783          	ld	a5,-64(s0)
    2308:	779c                	ld	a5,40(a5)
    230a:	f8f43023          	sd	a5,-128(s0)
    230e:	f8043783          	ld	a5,-128(s0)
    2312:	fd878793          	addi	a5,a5,-40
    2316:	fcf43023          	sd	a5,-64(s0)
    231a:	fc043783          	ld	a5,-64(s0)
    231e:	02878713          	addi	a4,a5,40
    2322:	649c                	ld	a5,8(s1)
    2324:	f2f71be3          	bne	a4,a5,225a <schedule_dm+0x72>
        }
    }
    ...
    232c:	4ff8                	lw	a4,92(a5)
    232e:	fac42783          	lw	a5,-84(s0)
    2332:	2781                	sext.w	a5,a5
    2334:	00e7cb63          	blt	a5,a4,234a <schedule_dm+0x162>
    ...
    2340:	f6f43823          	sd	a5,-144(s0)
    2344:	f6042c23          	sw	zero,-136(s0)
    2348:	a201                	j	2448 <schedule_dm+0x260>

    int executing_time = highest_priority_thread->remaining_time;
    234a:	fc843783          	ld	a5,-56(s0)
    234e:	4fbc                	lw	a5,88(a5)
    2350:	faf42e23          	sw	a5,-68(s0)

    // missing the deadline but still have some time to execute part of the task
    if (highest_priority_thread->remaining_time > highest_priority_thread->current_deadline - current_time) 
    2354:	fc843783          	ld	a5,-56(s0)
    2358:	4fb4                	lw	a3,88(a5)
    235a:	fc843783          	ld	a5,-56(s0)
    235e:	4ff8                	lw	a4,92(a5)
    2360:	fac42783          	lw	a5,-84(s0)
    2364:	40f707bb          	subw	a5,a4,a5
    2368:	2781                	sext.w	a5,a5
    236a:	8736                	mv	a4,a3
    236c:	00e7db63          	bge	a5,a4,2382 <schedule_dm+0x19a>
        executing_time = highest_priority_thread->current_deadline - current_time;
    2370:	fc843783          	ld	a5,-56(s0)
    2374:	4ff8                	lw	a4,92(a5)
    2376:	fac42783          	lw	a5,-84(s0)
    237a:	40f707bb          	subw	a5,a4,a5
    237e:	faf42e23          	sw	a5,-68(s0)

    struct release_queue_entry *cur;
    list_for_each_entry(cur, args.release_queue, thread_list) {
    2382:	689c                	ld	a5,16(s1)
    2384:	639c                	ld	a5,0(a5)
    2386:	f8f43c23          	sd	a5,-104(s0)
    238a:	f9843783          	ld	a5,-104(s0)
    238e:	17e1                	addi	a5,a5,-8
    2390:	faf43823          	sd	a5,-80(s0)
    2394:	a049                	j	2416 <schedule_dm+0x22e>
        int interval = cur->release_time - current_time;
    2396:	fb043783          	ld	a5,-80(s0)
    239a:	4f98                	lw	a4,24(a5)
    239c:	fac42783          	lw	a5,-84(s0)
    23a0:	40f707bb          	subw	a5,a4,a5
    23a4:	f8f42a23          	sw	a5,-108(s0)
        if (interval > executing_time) continue;
    23a8:	f9442703          	lw	a4,-108(s0)
    23ac:	fbc42783          	lw	a5,-68(s0)
    23b0:	2701                	sext.w	a4,a4
    23b2:	2781                	sext.w	a5,a5
    23b4:	04e7c263          	blt	a5,a4,23f8 <schedule_dm+0x210>
        if (highest_priority_thread->deadline < cur->thrd->deadline) continue;
    23b8:	fc843783          	ld	a5,-56(s0)
    23bc:	47f8                	lw	a4,76(a5)
    23be:	fb043783          	ld	a5,-80(s0)
    23c2:	639c                	ld	a5,0(a5)
    23c4:	47fc                	lw	a5,76(a5)
    23c6:	02f74b63          	blt	a4,a5,23fc <schedule_dm+0x214>
        if (highest_priority_thread->deadline == cur->thrd->deadline && highest_priority_thread->ID < cur->thrd->ID) continue;
    23ca:	fc843783          	ld	a5,-56(s0)
    23ce:	47f8                	lw	a4,76(a5)
    23d0:	fb043783          	ld	a5,-80(s0)
    23d4:	639c                	ld	a5,0(a5)
    23d6:	47fc                	lw	a5,76(a5)
    23d8:	00f71b63          	bne	a4,a5,23ee <schedule_dm+0x206>
    23dc:	fc843783          	ld	a5,-56(s0)
    23e0:	5fd8                	lw	a4,60(a5)
    23e2:	fb043783          	ld	a5,-80(s0)
    23e6:	639c                	ld	a5,0(a5)
    23e8:	5fdc                	lw	a5,60(a5)
    23ea:	00f74b63          	blt	a4,a5,2400 <schedule_dm+0x218>
        executing_time = interval;
    23ee:	f9442783          	lw	a5,-108(s0)
    23f2:	faf42e23          	sw	a5,-68(s0)
    23f6:	a031                	j	2402 <schedule_dm+0x21a>
        if (interval > executing_time) continue;
    23f8:	0001                	nop
    23fa:	a021                	j	2402 <schedule_dm+0x21a>
        if (highest_priority_thread->deadline < cur->thrd->deadline) continue;
    23fc:	0001                	nop
    23fe:	a011                	j	2402 <schedule_dm+0x21a>
        if (highest_priority_thread->deadline == cur->thrd->deadline && highest_priority_thread->ID < cur->thrd->ID) continue;
    2400:	0001                	nop
    list_for_each_entry(cur, args.release_queue, thread_list) {
    2402:	fb043783          	ld	a5,-80(s0)
    2406:	679c                	ld	a5,8(a5)
    2408:	f8f43423          	sd	a5,-120(s0)
    240c:	f8843783          	ld	a5,-120(s0)
    2410:	17e1                	addi	a5,a5,-8
    2412:	faf43823          	sd	a5,-80(s0)
    2416:	fb043783          	ld	a5,-80(s0)
    241a:	00878713          	addi	a4,a5,8
    241e:	689c                	ld	a5,16(s1)
    2420:	f6f71be3          	bne	a4,a5,2396 <schedule_dm+0x1ae>
    }

    struct threads_sched_result r;
    r.scheduled_thread_list_member = &highest_priority_thread->thread_list;
    2424:	fc843783          	ld	a5,-56(s0)
    2428:	02878793          	addi	a5,a5,40
    242c:	f6f43023          	sd	a5,-160(s0)
    r.allocated_time = executing_time;
    2430:	fbc42783          	lw	a5,-68(s0)
    2434:	f6f42423          	sw	a5,-152(s0)
    return r;
    2438:	f6043783          	ld	a5,-160(s0)
    243c:	f6f43823          	sd	a5,-144(s0)
    2440:	f6843783          	ld	a5,-152(s0)
    2444:	f6f43c23          	sd	a5,-136(s0)
    2448:	4701                	li	a4,0
    244a:	f7043703          	ld	a4,-144(s0)
    244e:	4781                	li	a5,0
    2450:	f7843783          	ld	a5,-136(s0)
    2454:	893a                	mv	s2,a4
    2456:	89be                	mv	s3,a5
    2458:	874a                	mv	a4,s2
    245a:	87ce                	mv	a5,s3
    245c:	853a                	mv	a0,a4
    245e:	85be                	mv	a1,a5
    2460:	60ae                	ld	ra,200(sp)
    2462:	640e                	ld	s0,192(sp)
    2464:	74ea                	ld	s1,184(sp)
    2466:	794a                	ld	s2,176(sp)
    2468:	79aa                	ld	s3,168(sp)
    246a:	6169                	addi	sp,sp,208
    246c:	8082                	ret
